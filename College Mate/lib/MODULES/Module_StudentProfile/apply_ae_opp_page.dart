...
class ApplyAeOppPage extends StatefulWidget {
  ...
  @override
  _ApplyAeOppPageState createState() => _ApplyAeOppPageState();
}

class _ApplyAeOppPageState extends State<ApplyAeOppPage> {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // _buildTextField(RoleController, 'Job Role'),
                    _buildDropdownField(),
                    SizedBox(height: 16.0),
  ...
  Future<void> _uploadResume(File resumeFile) async {
    ...
    DocumentReference documentReference = FirebaseFirestore.instance
        ...
        .doc(widget.studentId)
        .collection('EA Applied Opportunity')
        .doc(selectedRole)
        .collection('Applied')
        .doc();
