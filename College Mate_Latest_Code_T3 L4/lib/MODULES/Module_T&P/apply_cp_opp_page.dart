...
class ApplyCpOppPage extends StatefulWidget {
  ...
  @override
  _ApplyCpOppPageState createState() => _ApplyCpOppPageState();
}

class _ApplyCpOppPageState extends State<ApplyCpOppPage> {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildTextField(applicantNameController, "Applicant's Name"),
                    SizedBox(height: 10.0), // Increased space for better separation
                    _buildTextField(applicantEmailController, "Applicant's Email"),
                    SizedBox(height: 10.0), // Increased space for better separation
                    ...
                    SizedBox(height: 20.0), // Increased space for better separation
                    resumeFileName != null
                        ? Center(
                      child: Text(
